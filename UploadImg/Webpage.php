...
$sql='SELECT * FROM project where Theme="webpage"';
...
<body>
  ...
  <div class="col-sm-3" style="border:1px solid green;font-family:comic sans ms;text-align:center;border-radius:5px;">   
   <h4 style="font-family:rockwell"> <?php echo $user['Title'];?> </h4>
<p>
   <img src="images/<?php echo $user['Image']?>" 
class="img-thumbnail" style="width:100%;box-shadow:3px 5px 10px grey">
    </p>
